...
const characterPatchSchema = z
    .object({
        ...
        hunger: z.coerce.number().int().min(0).max(100).optional(),
        thirst: z.coerce.number().int().min(0).max(100).optional(),
        ...
        skillsAsignados: z.coerce.number().int().min(0).max(10).optional(),
...
const fieldMap = [
    ...
    ["skillsAsignados", "skills_asignados"],
...
function toCharacterResponse(
    ...
    return {
        ...
        skillsAsignados: character.skills_asignados,
