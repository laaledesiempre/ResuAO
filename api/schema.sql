...
-- Email becomes optional when instance registration allows it
-- (site_config.registration.requireEmail = false). NULLs stay unique-exempt.
ALTER TABLE accounts
...
ALTER TABLE clans
    DROP CONSTRAINT IF EXISTS clans_alignment_check;UPDATE clans cl
SET alignment = CASE
...
ALTER TABLE characters
    ADD COLUMN IF NOT EXISTS envenenado INTEGER NOT NULL DEFAULT 0;

ALTER TABLE characters
    ADD COLUMN IF NOT EXISTS puntos_atributo INTEGER NOT NULL DEFAULT 0;
